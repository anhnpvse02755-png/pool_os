...
void main() {
  ...
  final manifest = _json('$milestoneRoot/m19_freeze/contract_manifest.json');
  final proof = _json('$milestoneRoot/m19_freeze/proof_record.json');

  test('M19 planning inventory, sections, status, and dependencies are frozen',
      () {
    final artifacts =
  ...
  test('M19 freeze proof is canonical and deterministic', () {
    for (final key in [
  ...
  test('accepted M18 freeze and transitive M3-M18 chain remain unchanged', () {
    expect(proof['protectedM3M18'], 'unchanged');
    final protected =
