...
void main() {
  ...
  final manifest = _json('$root/m20_freeze/contract_manifest.json');
  final proof = _json('$root/m20_freeze/proof_record.json');

  test('M20 accepted planning inventory sections and graph are frozen', () {
    final artifacts =
  ...
  test('M20 proof is canonical and records replay metadata', () {
    for (final key in [
  ...
  test('M19 freeze and transitive M3-M19 chain remain unchanged', () {
    expect(proof['protectedM3M19'], 'unchanged');
    final protected =
