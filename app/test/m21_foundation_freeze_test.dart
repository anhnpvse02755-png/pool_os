...
void main() {
  ...
  final manifest = _json('$root/m21_freeze/contract_manifest.json');
  final proof = _json('$root/m21_freeze/proof_record.json');

  test('M21 accepted planning inventory sections and graph are frozen', () {
    final artifacts =
  ...
  test('M21 proof is canonical and records replay metadata', () {
    for (final key in [
  ...
  test('M20 freeze and transitive M3-M20 chain remain unchanged', () {
    expect(proof['protectedM3M20'], 'unchanged');
    final protected =
