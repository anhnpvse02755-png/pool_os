...
capabilities M4.1 through M4.5 are closed. The next governed capability is M4.6
Outcome Evaluation Projection Foundation. It must preserve frozen M3 contracts
and receive its own Product Owner review before repository closure.
