...
capability is M4.2 Adaptive Recommendation Engine Foundation. It must preserve
frozen M3 contracts and receive its own Product Owner review before repository
closure.
